let first = null;
let second = "https://discord.gg/ZWGY83Ng5B";
...
function openLink(value) {
    ...
    if (value == "rules") {
        window.location.href = "https://docs.google.com/document/d/1CYwNJjDl9KQSGgf_hoNdtfZgpPzq2p1C4SBqnHbWm4I/edit#heading=h.ocvpswguxa6m";
    }
    if (value == "contact") {
        window.location.href = "https://discord.gg/F8jJKvvjab";
    }
}
...
function aboutSlide(value) {
    if (value == 1) {
        ...
        document.getElementsByClassName('about-title1')[0].style.borderBottom = "0.2vw solid rgb(1,248,185)";
    ...
    if (value == 2) {
        ...
        document.getElementsByClassName('about-title2')[0].style.borderBottom = "0.2vw solid rgb(1,248,185)";
        document.getElementsByClassName('about-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title4')[0].style.borderBottom = null;
    }
    if (value == 3) {
        ...
        document.getElementsByClassName('about-title1')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title3')[0].style.borderBottom = "0.2vw solid rgb(1,248,185)";
        document.getElementsByClassName('about-title4')[0].style.borderBottom = null;
    }
    if (value == 4) {
        document.getElementsByClassName('intext')[0].style.transition = "all 1s";
        ...
        document.getElementsByClassName('about-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title4')[0].style.borderBottom = "0.2vw solid rgb(1,248,185)";
    }
}
